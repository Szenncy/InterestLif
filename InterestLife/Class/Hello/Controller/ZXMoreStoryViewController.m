...
#import "ZXMoreStoryViewController.h"

@interface ZXMoreStoryViewController ()
//自定义NavBar
...
@implementation ZXMoreStoryViewController
#pragma mark - 初始化
...
- (void)initData{
    ...
    self.contentViewHeight.constant = 230 - 20 + size.height;
