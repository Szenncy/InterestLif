...
#import "ZXCollectViewController.h"
#import "ZXTopCommentView.h"
#import "UIViewController+ZXTabBar.h"

@interface ZXCollectViewController ()
...
@implementation ZXCollectViewController
...
- (void)initNav{
    ...
    self.navBar.leftTitle = @"有意思";
    
    self.navBar.rightTitle = @"也有意思";
